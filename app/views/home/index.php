<section class="seccion">
    <div class="seccion-img mt-2">
        <img class="img-portada-principal" src="assets/img/portada-3.png!sw800" alt="not found file">
    </div>
    ...
    <div class="seccion-text-portada py-2">
        ...
        <div class="content-controls col-12 py-2">
            <button class="btn btn-md btn-primary col-10">
...
<section class="seccion">
    <div class="seccion-img mt-2">
        <div class="seccion-img">
            <img class="img-portada-principal" src="assets/img/portada-2.png" alt="Not found img">
        </div>
    </div>
...
<section class="seccion">
    <div class="seccion-img mt-2">
        <img class="img-portada-principal" src="assets/img/portada-4.png" alt="not found img">
    </div>
...
<section class="seccion">
    <div class="seccion-img mt-2">
        <img class="img-portada-principal" src="assets/img/portada-5.png" alt="not found img">
    </div>
...
<section class="seccion">
    <div class="seccion-img mt-2">
        <img class="img-portada-principal" src="assets/img/portada-1.png" alt="not found img">
    </div>
